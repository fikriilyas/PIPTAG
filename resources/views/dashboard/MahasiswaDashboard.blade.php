    ...
    <div class="flex justify-center">
        <div class="w-8/12 bg-white p-6 rounded-lg">
            ...
            <div class="flex">
                ...
                <div class="text-xs text-center md:text-base">Pilih Perusahaan</div>
                </div>
                ...
                <div class="text-xs text-center md:text-base">Jurnal</div>
                </div>
                ...
                <div class="text-xs text-center md:text-base">Laporan Akhir</div>
                </div>
            </div>
            </div>
        </div>
